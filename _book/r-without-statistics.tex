...
\href{https://rfortherestofus.com/2018/12/descriptive-stats-r/}{The only statistics in R are descriptive statistics}. Counts, sums, averages: they are the statistics that I do in R.
...
\tightlist
\item
  \textbf{Data visualization}: making graphs, maps, and tables that look good and communicate effectively.
\item
...
I realize now that the things that I use R for \emph{are} the things that everyone uses R for. R was created for statistics. But today you can use R without statistics.
