...
```{r quarto-slides, out.width="100%", fig.cap="TODO"}
...
```{r render-website-button, out.width="100%", fig.cap="TODO"}
...
```{r quarto-website-navbar-changes, out.width="100%", fig.cap="The website with chnages to the navigation bar"}
