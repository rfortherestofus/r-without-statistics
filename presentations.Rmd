...
We can see our slide in Figure \@ref(fig:TODO).

TODO: penguins-report.png

If I wanted to change the font, I could do so with some additional CSS. The first line of this code will make a font called Inter available to us. The two lines I added will make the h2 use the Inter font and make it bold. 
...
The slide with bold Inter font is visible in Figure \@ref(fig:TODO).

TODO: penguins-report-inter.png
...
You can see how this theme changes the look-and-feel of our slides in Figure \@ref(fig:TODO) below.

TODO: Add xaringan-metropolis.png
...
The third benefit of using `xaringan` is accessibility. People with limited vision are able to access HTML documents in ways that make them accessible. As Canelón put it to me, "when [people] have the HTML version of the slides, they have some control over what it looks like." They can increase the text size or use screen readers. Making presentations with `xaringan` isn't just a cool trick. It also means more people can engage with your slides. 