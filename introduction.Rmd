...
```{r out.width="100%", fig.cap="Sample pages from a report on housing in demographics in Hartford, Connecticut"}
knitr::include_graphics(here::here("assets/psc-sample.png"))
```
...
```{r out.width="100%", fig.cap="A typical non-R workflow"}
knitr::include_graphics(here::here("assets/non-r-workflow.png"))
```
...
```{r out.width="100%", fig.cap="An R-based workflow"}
knitr::include_graphics(here::here("assets/r-workflow.png"))
```
...
```{r out.width="100%", fig.cap="An workflow that brings data from Google Sheets directly into R"}
knitr::include_graphics(here::here("assets/google-sheets-workflow.png"))
```
