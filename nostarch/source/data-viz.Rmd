...
```{r gapminder-viridis-plot, ref.label = "gapminder-viridis", echo = FALSE, fig.cap="The same chart with a colorblind-friendly palette"}
```
...
```{r drought-viz-theme-tweaks-plot, ref.label = "drought-viz-theme-tweaks", fig.height = 8, echo = FALSE, fig.cap="Figure 1-16	Faceted version of the drought visualization with gray backgrounds behind each small multiple"}
```
