...
```{r results='asis', include = TRUE, echo = FALSE, fig.cap = "Table with gridlines everywhere"}
...
```{r results='asis', include = TRUE, echo = FALSE, fig.cap = "Table with only horizontal gridlines"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, echo = FALSE, fig.cap = "Table with gridlines only on the header row and bottom"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, echo = FALSE, fig.cap = "Table with all gridlines removed"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with header row bolded"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with year columns aligned left, center, and right"}
print_nostarch_file_name(file_type_to_print = "png")
...
Right alignment is best practice for numeric columns, but for text columns, we want to use left alignment. As Jon Scwabish points out, it's much easier to read country names when they are left aligned. This is even easier to see if we add a country with a long name to our table. I've added Bosnia and Herzegovina and saved this as a data frame called `gdp_with_bosnia`. 
...
```{r results='asis', include = TRUE, fig.cap = "Table with Country column center aligned"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with Country column left aligned"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with numbers rounded to whole numbers and dollar sign added"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with color added to show the highest value in each year"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table with sparkline added to show trend over time"}
print_nostarch_file_name(file_type_to_print = "png")
...
```{r results='asis', include = TRUE, fig.cap = "Table redone in FiveThirtyEight style"}
print_nostarch_file_name(file_type_to_print = "png")
