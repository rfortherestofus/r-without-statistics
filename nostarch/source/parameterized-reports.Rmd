...
# Parameterized Reporting {#parameterized-reports-chapter}
...
If you run the `pwalk(reports, render)` code, you should see 51 HTML documents appear. Each one should consist of a report for that state, complete with a customized graph and accompanying text.
