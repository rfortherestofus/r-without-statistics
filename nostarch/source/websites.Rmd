...
```{r new-distill-website, out.width="100%", fig.cap="Giving your distill website a name"}
...
- Use wider the layouts to make content fit better on individual pages.
