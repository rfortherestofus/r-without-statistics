...
```{r penguins-plot-axes-plot, ref.label = "penguins-plot-axes", echo = TRUE, fig.cap = "Our chart with changes to axis formatting"}
```
...
```{r penguins-plot-gridlines-plot, ref.label = "penguins-plot-gridlines", echo = TRUE, fig.cap = "Our chart with tweaks to the grid lines"}
```
