...
```
∂
```{r new-xaringan-document, out.width="100%", fig.cap="The options presented to create a new presentation"}
knitr::include_graphics(here::here("assets/new-xaringan-document.png"))
```

```{r results='asis'}
save_image_for_nostarch(here::here("assets/new-xaringan-document.png"))
```
