...
Getting started with R can be challenging. I myself experienced many confusions that I've since realized are quite common. This chapter has, hopefully, helped you to see how you can get started with R. Understanding how functions, objects, packages, and projects work is key to ensuring that you can use R to work with your data. 

If R feels challenging, just know that a) I feel your pain, and b) it will get better. Best of all, the time you invest in learning to use R will repay itself many times over. My favorite example to show this is one I discuss in Chapter \@ref(parameterized-reporting-chapter). In that chapter, you'll learn to use a technique called parameterized reporting to automatically produce dozens, hundreds, or even thousands of reports at once. At my company, R for the Rest of Us, we worked with a client to produce reports on demographics and housing data for each of the 170 plus towns and counties in the state of Connecticut. Doing this by hand would have taken our client hundreds of hours. Using R, we were able to automate the process. If you make multiple reports by hand, think of the hours you're spending. Reframe the time it takes to learn R as an investment in reducing manual labor. When you're struggling to make sense of an inscrutable error, it may not feel worth the effort to learn R, but I promise it is. 
