...
Being able to tell R to run the Alabama row to generate its report, then the Alaska row, and so on is a huge time-saver. If I run the `pwalk(reports, render)` code, in short order I'll see 51 HTML documents appear. And each one will be a report for that state, complete with text and charts customized for that state.  