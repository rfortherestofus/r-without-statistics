...
```{r table-with-all-borders, echo = TRUE, include = FALSE}
gdp %>% 
  gt() %>% 
  tab_style(
    style = cell_borders(
...
```{r ref.label = "table-with-all-borders", echo = FALSE, include = TRUE}
```
...
```{r remove-gridlines, echo = TRUE, include = FALSE}
gdp %>% 
  gt() %>% 
  tab_style(
...
```{r ref.label = "remove-gridlines", echo = FALSE, include = TRUE}
```
