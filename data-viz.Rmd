...
```{r gapminder-points, echo = FALSE, include = TRUE, fig.cap="The same chart but with points added"}
```
...
```{r gapminder-line, echo = FALSE, fig.cap="The data as a line chart"}
```
...
```{r gapminder-points-line, echo = FALSE, fig.cap="The data with points and a line"}
```
...
```{r gapminder-bar, echo = FALSE, fig.cap="The data as a bar chart"}
```
...
```{r gapminder-bar-colors, echo = FALSE, fig.cap="The same chart, now with added colors"}
```
