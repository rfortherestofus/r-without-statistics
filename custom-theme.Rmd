...
```{r ggplot-theme-cheatsheet, out.width="100%", fig.cap="Cheatsheet for working with ggplot themes"}
# TODO: Reformat this so it fits in the book
knitr::include_graphics(here::here("assets/ggplot_theme_system_cheatsheet.png"))
```

```{r results='asis'}
save_image_for_nostarch(here::here("assets/ggplot_theme_system_cheatsheet.png"))
```
