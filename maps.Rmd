...
We can plot this as well, but before doing so, I'm going to use the `shift_geometry()` function from `tigris`. This will put Alaska, Hawaii, and Puerto Rico in places that it is easier to see all states. It also resizes these three states to make them easier to compare to other states. 
...
Kyle Walker, developer of the `tigris` package, has written an entire book that yo


US

- albersusa
- tigris (can shift geometry like usa_sf())
- tidycensus
...
https://geocompr.robinlovelace.net/reproj-geo-data.html?q=wgs#which-crs
...
#### You can use tidyverse the whole time

### Conceptual Stuff: Why R is Best Tool for Maps

#### You don't need to be GIS expert

#### Keep everything within R
...
Can make interactive maps

Can use data viz principles
