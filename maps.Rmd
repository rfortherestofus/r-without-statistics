...
- Sets the height and width of each colored square (.75 centimeters for each)
- Sets the font family, size, and margin of both the labels (the ">0," ">5," and so on) and the title ("COVID-19 INCIDENCE RATE")
