...
And Herman also makes interactive tables, allowing the user to scroll through the data and sort by any of the variables in it.

TODO: Add screenshot

Let's add some interactivity to our website.
